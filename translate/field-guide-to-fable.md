...
requestedUrl: "https://x.com/i/article/2073090223194755072"
author: "Thariq (@trq212)"
authorName: "Thariq"
authorUsername: "trq212"
authorUrl: "https://x.com/trq212"
coverImage: "https://pbs.twimg.com/media/HMUY_HnbcAAa51I?format=jpg&name=4096x4096"
siteName: "X"
publishedAt: "Fri Jul 03 17:43:35 +0000 2026"
summary: "Working with Claude Fable 5 keeps re-teaching me an old lesson: the map is not the territory."
adapter: "x"
kind: "x/article"
tweetId: "2073100352921215386"
---
...
![](https://pbs.twimg.com/media/HMUY0Dpa4AA__qj?format=jpg&name=4096x4096)
...
I've made some https://thariqs.github.io/html-effectiveness/unknowns/ but be sure to come back to build the intuition for when to use them.
...
![](https://pbs.twimg.com/media/HMUa_3jbcAAJeRy?format=jpg&name=4096x4096)

The best agentic coders are good have relatively few unknowns. Watching someone like https://www.linkedin.com/in/bcherny or https://www.linkedin.com/in/jarred-sumner-a8772425 prompt, it is obvious to me that they know what they want in-detail. They are deeply in-sync with both the codebase and the model behaviors.
...
![](https://pbs.twimg.com/media/HMUZ8FWacAAK4eL?format=jpg&name=4096x4096)
...
I've previously written about using https://x.com/trq212/status/2052809885763747935, in almost all of these cases, a HTML artifact is the best way to visualize and represent it.
...
![](https://pbs.twimg.com/media/HMUbXPhaoAIKuhv?format=jpg&name=4096x4096)
...
I ask Claude Code to keep a temporary ‘http://implementation-notes.md (or .html) file where it keeps track of decisions it makes so we can learn from our next attempt.

Example prompts:

- "Keep an http://implementation-notes.md file. If you hit an edge case that forces you to deviate from the plan, pick the conservative option, log it under 'Deviations', and keep going."

# Post implementation

## Pitches and explainers

![](https://pbs.twimg.com/media/HMUce7UaEAAegM5?format=jpg&name=4096x4096)
...
The https://x.com/ClaudeDevs/status/2064399512664526853 was edited entirely by Claude Code. This was a new domain for me and I’m by no means an expert.
...
You can watch a more in-depth explanation on that https://x.com/trq212/status/2064826394589442448/video/1.
